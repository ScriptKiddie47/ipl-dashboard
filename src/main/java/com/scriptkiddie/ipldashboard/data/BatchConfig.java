...
public class BatchConfig {
    private final String[] FIELDNAMES = new String[] { "id", "city", "date", "player_of_match", "venue",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReader")
                .resource(new ClassPathResource("IPL_Matches_2008-2020.csv")).delimited().names(FIELDNAMES).linesToSkip(1)
